...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 15, 2020 lúc 06:36 PM
...
(21, 4, 'Penguin Trap - Bẫy chim cánh cụt', 12, 200000, 'Người chơi cùng lắp ghép để xếp sàn băng và đặt chim cánh cụt lên đó. Sau đó, người chơi lần lượt dùng búa để đập các tảng băng theo vòng sau. Cứ khéo léo đập từng tảng băng, người nào làm chim cánh cụt ngã sẽ là người thua cuộc! ', 'boa1493805159.jpg', '1'),
(22, 4, 'Xếp Toán - Cộng Trừ', 12, 120000, 'Xếp Toán Cộng Trừ là một sản phẩm made in Vietnam với chất lượng cực tốt, an toàn, đảm bảo sẽ khiến bạn hài lòng. Vừa học, vừa chơi cùng với Xếp Toán, phiên bản Cộng Trừ!', 'dsc1491805217.jpg', '1'),
(23, 4, 'Dixit (US)', 12, 670000, 'Dixit là trò chơi tuyệt vời được thiết kế cho 3-6 người (12 với các bản Dixit mở rộng) và thực sự dễ hiểu với bất kì ai. Về cơ bản, Dixit chỉ là 1 cỗ bài quá khổ đẹp kì lạ và mơ hồ được vẽ bởi các danh họa Marie Cardouat, Piero và Xavier.', 'pic1565229593.jpg', '1'),
...
(25, 4, 'Five Tribes (US)', 12, 1305000, 'Nếu các bạn đã từng chơi Ô ăn quan, các bạn hẳn sẽ rất thích thú với tựa game này. Trong Five Tribes, người chơi lần lượt lấy toàn bộ meeple ở 1 ô bất kỳ và rải chúng lên từng ô cạnh đó. Bạn sẽ thu về tất cả meeple cùng màu với meeple cuối cùng mà bạn rải ở ô đó và thực hiện chức năng của nó. Thật đơn giản phải không nào?', 'fiv1497435355.jpg', '1'),
(27, 4, 'Imhotep (US)', 14, 1170000, 'Trải qua sáu vòng, họ di chuyển những hòn đá bằng gỗ để tạo ra năm tượng đài và đến lượt, một người chơi chọn một trong bốn hành động: Mua đá mới, nạp đá trên thuyền, đưa thuyền đến tượng đài hoặc chơi một hành động Thẻ. Mặc dù điều này nghe có vẻ dễ dàng, nhưng những người chơi khác liên tục cản trở các kế hoạch xây dựng của bạn bằng cách thực hiện các kế hoạch của riêng họ. Chỉ những người có thời gian tốt nhất - và những viên đá để sao lưu kế hoạch của họ - mới chứng tỏ là người xây dựng tốt nhất của Ai Cập.', 'pic1504924193.jpg', '1'),
(28, 8, '7 Wonders Armada (US)', 12, 1180000, '7 Kỳ quan: Armada là bản mở rộng của 7 Kỳ quan có thể kết hợp với trò chơi cơ bản hoặc bất kỳ bản mở rộng nào. Mỗi người chơi chịu trách nhiệm về một Hội đồng \"Hải quân\" khi bắt đầu trò chơi của họ cùng với Hội đồng Wonder của họ. 7 Kỳ quan: Armada bao gồm các thẻ đỏ, xanh lá cây, vàng và xanh dương bổ sung để xáo trộn vào bộ bài. So sánh sức mạnh của bạn với mọi người chơi cùng bàn, và không chỉ những người bên cạnh bạn. Chiến đấu trên vùng biển để giành điểm Chiến thắng!', '7_w1588648037.jpg', '1'),
(29, 8, 'Dozen War', 14, 1700000, 'Dozen War (Thập Nhị Chiến) là một board game chiến thuật  được sáng tạo bởi người Việt, lấy bối cảnh một thế giới giả tưởng có tên là Mativen cùng với cuộc chiến giữa 12 vị anh hùng.', 'art1547451645.png', '1'),
(30, 8, 'The Manhattan Project', 13, 1705000, 'Trong the Manhattan Project, bạn sẽ trở thành những nhà lãnh đạo các cường quốc trong Thế chiến II, chạy đua vũ trang với nhau trong công cuộc chế tạo những quả bom nguyên tử có sức công phá lớn, đem lại điểm chiến thắng nhất định. Người dành được số điểm mà trò chơi đề ra (tùy theo số người chơi) đầu tiên sẽ trở thành quốc gia thống trị thế giới, và giành chiến thắng chung cuộc.', 'pic1554974085.jpg', '1'),
(31, 8, 'Root (US)', 12, 1890000, 'Root được xem như là bước tiếp theo của Leders Games từ sau Vast: The Crystal Caverns. Một tựa game thể loại phiêu lưu và chiến tranh tranh giành lãnh thổ của các chủng sinh vật sống trong rừng, trong đó những người chơi sẽ chiến đấu để giành quyền kiểm soát khu rừng rộng lớn', 'pic1554970264.jpg', '1'),
